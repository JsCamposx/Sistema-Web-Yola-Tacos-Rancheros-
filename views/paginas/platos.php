...
<div class="platos__main">
    <!--
    <div class="platos__playist">
        <div class="platos__playist--pad">
            <img src="img/platos/icono-playist.webp" class="platos__playist--img rotater" width="100%" height="100%" alt="Card img">
            <h1>Escucha nuestra Playlist</h1>
        </div>

       
        <iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/2tQ1TOf1P0V5JdPRYTfyFn?utm_source=generator&theme=0" width="100%" height="352" frameborder="0" allowfullscreen="" allow="clipboard-write; encrypted-media; picture-in-picture" loading="lazy"></iframe>
        -->
</div>
</div>
</div>